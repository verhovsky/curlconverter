...
export type OperationConfig = {
  ...
  postfields?: PostField[]; // TODO: this is a string
...
//   url_ul?: getout;    /* point to the node to fill in upload */
  ...
  preproxy?: string;
  socks5_gssapi_nec?: number;    /* The NEC reference server does not protect the
