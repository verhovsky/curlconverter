...
function ensure_minimum_exponent_length(number: string): string {
  // If there's only 1 exponent digit, add a leading 0 to the exponent
...
function floatAsPython(value: number): string {
  ...
  //
  // And JavaScript's formatting is defined here:
